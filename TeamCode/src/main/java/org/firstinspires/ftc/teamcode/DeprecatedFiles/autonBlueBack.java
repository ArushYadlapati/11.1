package org.firstinspires.ftc.teamcode.DeprecatedFiles;
...
//        motorFrontRight.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        ...
        encoderMove(360,36, 0.30);
        encoderMove(0, -12,0.30);
//        encoderMove(90,30,0.30);


        //encoderMove(360,-12, 0.30);
...
//        motorFrontRight.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        ...
        switch (direction) {
            ...
            case 45: // Move the top left and bottom right mecanum wheels forward
                ...
                backRightPower = speed;
                break;
            case 90: // Move the top left and bottom right forward, bottom left and top right backward (left)
                frontLeftPower = -speed;
                backLeftPower = speed;
                frontRightPower = speed;
                backRightPower = -speed;
